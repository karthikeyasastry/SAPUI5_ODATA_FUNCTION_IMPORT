		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lot Mark Print",
									"targetURL": "#LotMarkPrint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LotMarkPrint-display": {
								"semanticObject": "LotMarkPrint",
								"action": "display",
								"description": "Lot Mark Print",
								"title": "Lot Mark Print",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hirose.mnp.lotmarkprint.ziemnplotmarkprint",
									"url": sap.ui.require.toUrl("com/hirose/mnp/lotmarkprint/ziemnplotmarkprint")
								}
							}
						}
					}
